...
?>
	<div id="main112">
	<center>
	<form action = "Report_VesselType.php" method = "post" >Vessel Type Lists Report Search <font color="red">By Vessel Type</font><br/>
 <input type="text" size="35" id="VesselType" name="VesselType" Placeholder="Enter Vessel Type"><input type="submit" value="Search"></form>
</color>
	<table border='1' >
