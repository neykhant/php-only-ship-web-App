...
$result = mysql_query("SELECT * FROM `Peacock`.`Vessel` WHERE `Vessel`.`VesselName`= '$VName'");
?>
	<div id="main1">
	<center>
...
<td><div id="Del"><a href = "Delete_Vessel.php? VesselID=<?php echo $row['VesselID'] ?>" >Del</a>&nbsp;<a href = "Update_Vessel.php? VesselID=<?php echo $row['VesselID'] ?>" >Update</a> </div></td>
</tr>
