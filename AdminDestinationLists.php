...
?>
	<div id="main112">
	<center>
	<form action = "Report_DestinationName.php" method = "post" >Destination Lists Report Search <font color="red">By Destination Name</font><br/>
 <input type="text" size="35" id="DName" name="DName" Placeholder="Enter Destination Name"><input type="submit" value="Search"></form>
</color>
...
<td><div id="Del"><a href = "DeleteDes.php? DestinationID=<?php echo $row['DestinationID'] ?>" >Del</a>&nbsp;<a href = "Update_Destination.php? DestinationID=<?php echo $row['DestinationID'] ?>" >Update</a> </div></td>
</tr>
