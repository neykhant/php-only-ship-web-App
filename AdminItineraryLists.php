...
?>
	<div id="main112">
	<center>
	<form action = "Report_ItineraryName.php" method = "post" >Itinerary Lists Report Search <font color="red">By Itinerary Name</font><br/>
 <input type="text" size="35" id="ItineraryName" name="ItineraryName" Placeholder="Enter Itinerary Name"><input type="submit" value="Search"></form>
</color>
	<table border='1' >
