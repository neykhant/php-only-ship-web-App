...
<li><a href="index.php">Logout</a></li>
	...
	<div id="Itinerary">
	<center>
	<form action="DestinationDB.php" method="post" enctype="multipart/form-data">
	<table cellpadding="10px">
	<caption><h1> Destination</h1></caption>
	<tr>
	<td> <label> Destination Name </label></td><td>:</td>
	<td> <select name="DName">
	<option value="London Tower Hill"> London Tower Hill </option>
	...
	<tr>
	<td> <label> Destination Image</label></td><td>:</td>
	<td> <input type="file" size="30" placeholder="Enter Destination Image" required="required" name="DImage"></td>
	</tr>
	
	<tr>
	<th colspan="3">
	<input type="submit" value="Destinatin" class="button1">&nbsp; <input type="reset" value="Cancel" class="button1"></th>
	</tr>
	</table>
	</form>
