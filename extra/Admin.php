...
<script type="text/javascript" src="script.js"></script>
	...
	<div id="bander">
	<ul class="nav">
<li><a href="Admmin.php">Admin Staff Register</a></li>
<li><a href="AdminStaffLogin.php"> Admin Staff Login</a></li>

</ul></div>
	<div id="Itinerary1">
	<center>
	<form action="AdminStaffDB.php" method="post">
	<table cellpadding="10px">
	<caption><h1> Admin Staff Register</h1></caption>
	<tr>
	<td> <label> Admin  Staff Name </label></td><td>:</td>
	<td> <input type="text" size="30" placeholder="Enter Admin Name"  name="AdminStaffName" required maxlength="30" pattern="[A-Za-z0-9. ]{3,30}" title="Any letters or digits but not special characters" autofocus /></td></tr>
	<tr>
	...
	If you have already account <a href="AdminLogin.php"> Admin Login </a>
	</center></div>
	</body>
</html>